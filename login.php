...
if(isset($_POST['submit']))
{
    ...
    //echo $EncryptPass;
	$rs=mysqli_query($conn,"select * from userprofile where Email='$email' and pwd='$EncryptPass'");
...
<?php
	...
	//echo $_SESSION['email'];
		  header("Location: medsearch.php");
			 ...
			 if(isset($found))
	{
		echo "<p style='color: Red; font-family: Times New Roman;'>Invalid user id or password<br><a href='loginaftersignup.php'>Please try again</p>";	
	}
